        ...
        <div class="container grid grid--2-cols margin-bottom-md">
          <div class="princing-plan princing-plan--starter">
            <header class="plan-header">
              ...
              <p class="plan-price"><span>Rs.</span>399</p>
              <p class="plan-text">per month. That's just Rs.13 per meal!</p>
            </header>
            <ul class="list">
              <li class="list-item">
          ...
          <div class="princing-plan princing-plan--complete">
            <header class="plan-header">
              ...
              <p class="plan-price"><span>Rs</span>649</p>
              <p class="plan-text">per month. That's just Rs11 per meal!</p>
            </header>
            <ul class="list">
              <li class="list-item">
                <ion-icon class="list-icon" name="checkmark-outline"></ion-icon>
